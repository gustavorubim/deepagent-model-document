...
def parse_docx_template(docx_path: Path) -> ParsedTemplate:
    """Parse DOCX headings and gather section bodies.
...
def validate_docx_template(parsed: ParsedTemplate) -> list[str]:
    """Validate DOCX-specific expectations."""
